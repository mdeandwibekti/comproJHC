...
// 2. Jika Mode Edit, Ambil Data Dokter (Termasuk Deskripsi)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $description = trim($_POST["description"]); // Data baru
    ...
    // Logic Simpan: INSERT atau UPDATE
    if (empty($id)) {
    ...
    <div class="main-wrapper">
        <div class="page-header-jhc d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted small mb-0">Lengkapi data profil dokter untuk ditampilkan pada sistem reservasi RS JHC.</p>
            </div>
        ...
        <form action="doctor_edit.php<?php echo $id ? '?id='.$id : ''; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-5">
                <div class="col-md-7">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="specialty" class="form-control" value="<?php echo htmlspecialchars($specialty); ?>" placeholder="Contoh: Spesialis Jantung" required>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="schedule" class="form-control" rows="3" placeholder="Contoh: Senin - Jumat: 09.00 - 14.00"><?php echo htmlspecialchars($schedule); ?></textarea>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label text-muted small">Tentang Dokter (Profil/Bio)</label>
                            <textarea name="description" class="form-control" rows="6" placeholder="Tuliskan riwayat pendidikan, pengalaman, atau informasi tambahan tentang dokter..."><?php echo htmlspecialchars($description); ?></textarea>
                            <small class="text-muted small">Deskripsi ini akan tampil pada pop-up detail dokter di halaman depan.</small>
                        </div>

                        <div class="col-md-12 mt-4">
                            <div class="form-check form-switch p-0 d-flex align-items-center">
                                <label class="form-check-label me-4 fw-bold text-dark" for="featuredCheck">Dokter Unggulan?</label>
                ...
                <div class="col-md-5">
                    ...
                    <div class="mb-3">
                        <label class="small text-muted mb-2">Unggah Foto Baru:</label>
