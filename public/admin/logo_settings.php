...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $mysqli->prepare($sql)) {
        ...
        if (isset($_FILES["header_logo"]) && $_FILES["header_logo"]["error"] == 0) {
            $new_filename = uniqid() . '-header-' . basename($_FILES["header_logo"]["name"]);
        ...
        $stmt->bind_param("ss", $key, $footer_logo_path);
        $stmt->execute();

        // --- 3. Favicon ---
        $favicon_path = $_POST['current_favicon_path'] ?? '';
        if (isset($_FILES["favicon"]) && $_FILES["favicon"]["error"] == 0) {
            $new_filename = uniqid() . '-favicon-' . basename($_FILES["favicon"]["name"]);
...
<div class="container-fluid">
    ...
    <form action="logo_settings.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            ?>
                <img src="../<?php echo htmlspecialchars($header_logo_path); ?>" width="150" class="img-thumbnail mb-2" style="background: #ccc;"><br>
            <?php endif; ?>
        ...
        <div class="form-group mt-4">
            ...
            ?>
                <img src="../<?php echo htmlspecialchars($footer_logo_path); ?>" width="150" class="img-thumbnail mb-2" style="background: #ccc;"><br>
            <?php endif; ?>
        ...
        <div class="form-group mt-4">
            ...
            ?>
                <img src="../<?php echo htmlspecialchars($favicon_path); ?>" width="32" class="img-thumbnail mb-2"><br>
            <?php endif; ?>
