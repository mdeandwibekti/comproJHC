...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $mysqli->prepare($sql)) {
        ...
        if (isset($_FILES["news_section_bg_image"]) && $_FILES["news_section_bg_image"]["error"] == 0) {
            ...
            $upload_dir = "../assets/img/gallery/"; // Assuming gallery is suitable for backgrounds
    ...
    header("location: news_settings2.php?saved=true");
    exit();
}
?>
<div class="container-fluid">
    ...
    <form action="news_settings2.php" method="post" enctype="multipart/form-data">
        <div class="form-group"><label>Section Title</label><input type="text" name="news_section_title" class="form-control" value="<?php echo htmlspecialchars($settings['news_section_title'] ?? ''); ?>"></div>
        ...
        <div class="form-group mt-3">
            ...
            if($bg_image_path): 
            ?><img src="/comprojhc/public/<?php echo htmlspecialchars($bg_image_path); ?>" width="200" class="img-thumbnail mb-2"><br><?php endif; ?>
