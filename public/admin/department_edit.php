...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $category = trim($_POST["category"]); // Ambil input category
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label>Department / Service Name</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Category (Untuk Pemisahan Tampilan)</label>
