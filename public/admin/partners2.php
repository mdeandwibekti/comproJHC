...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="partner_edit.php" class="btn btn-primary">Add New Partner</a>
    </div>
    <hr>
    <?php
        ...
        <tbody>
            ...
            if ($result && $result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo "<a href='partner_edit.php?id=" . $row['id'] . "' class='btn btn-sm btn-info'>Edit</a> ";
                    echo '<a href="partners.php?delete=' . $row['id'] . '" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure you want to delete this partner?\');">Delete</a>';
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
